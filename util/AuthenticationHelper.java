package demo;// Authentication Helper — The demo.Main Logic that passes through Cognito
...
public class AuthenticationHelper {
    // This hex item is used across different tutorials
    ...
    private InitiateAuthRequest initiateUserSrpAuthRequest(String username) {
        ...
        initiateAuthRequest.setAuthFlow(AuthFlowType.USER_SRP_AUTH); // will take in USERNAME and SRP_A and return the SRP variables to be used for next challenge execution.
